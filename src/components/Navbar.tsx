        ...
        <div className="w-full">
            <nav className="px-16 bg-main-red w-full h-[120px] items-center justify-between flex fixed z-50">
                <Link 
                    ...
                    to="/">
                    <img className="" alt="movie icon" src="/assets/movie-icon.svg"></img>
            ...
            <div className=" bg-[url('/assets/curtain.png')] w-full h-[350px] top-10 bg-cover bg-center absolute z-[-100]"></div>
        </div>
    )
}
